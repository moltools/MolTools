...
const MatchBuilder = ({ queryItems, setQueryItems, submissionElement }) => {  
    const handleAddPolyketideModule = () => {
        const newItem = {
            id: uuidv4(),
        ...
        <div className="control" style={{border: "1px solid #dbdbdb", borderRadius: "5px", marginBottom: "10px"}}>
            <div className="panel">
                <div className="panel-heading">
                    <div className="title is-5">Match editor</div>
                </div>
                <div className="panel-block">
                    <div className="field has-addons">
                        <div className="control">
                            <button className="button is-link is-light" onClick={handleAddPolyketideModule} style={{marginRight: "5px"}}>
                                Add module
                            </button>
                        </div>
                    </div>
                                                                    ...
                                                                    <div className="field has-addons">
                                                                                    ...
                                                                                    onClick={() => {
                                                                                        const updatedItems = queryItems.map((queryItem, i) => {
                                                                                            if (i === index) { 
                                                                                                ...
                                                                                                queryItem.properties = {
                                                                                                    classification: "polar and charged",
                                                                                                    pubchem_cid: null
                                                                                                };
                                                                                            }
                                                                                            return queryItem;
                                                                                    ...
                                                                                    <span style={{ textTransform: 'capitalize' }}>
                                                                                        {
                                                                                            ...
                                                                                            item.properties.accessory_domains.length === 3 ? "D" : "A"
                                                                                        }
                                                                                    </span>
                                                                                    <span className="icon is-small">
                                                                                        <i className="fas fa-angle-down" aria-hidden="true"></i>
                                                                        ...
                                                                        {item.identifier === "polyketide" ? (
                                                                            <div className="dropdown is-hoverable" style={{marginRight: "5px"}}>
                                                                                <div className="dropdown-trigger">
                                                                                    <button className="button" aria-haspopup="true" aria-controls="dropdown-menu">
                                                                                    <span>{item.properties.decoration_type}
                                                                                    </span>
                                                                                    <span className="icon is-small">
                                                                                        <i className="fas fa-angle-down" aria-hidden="true"></i>
                                                                                    </span>
